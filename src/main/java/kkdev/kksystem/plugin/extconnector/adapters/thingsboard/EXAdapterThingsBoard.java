 ...
 */
package kkdev.kksystem.plugin.extconnector.adapters.thingsboard;

import kkdev.kksystem.plugin.extconnector.adapters.inet.*;
 ...
 * @author sayma_000
 */
public class EXAdapterThingsBoard implements IEXAdapter {
    ...
    public EXAdapterThingsBoard(EXAdapterConfig Conf, IEXConnManager Conn) {
        Configuration = Conf;
        ConnManager = Conn;
